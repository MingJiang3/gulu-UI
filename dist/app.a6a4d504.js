...
{
  var Constructor = _vue.default.extend(_button.default); //把butto组件变成构造函数，Button就是对象
  ...
  var href = userElement.getAttribute('xlink:href');
...
}
{
  ...
  var _userElement = _vm.$el.querySelector('use');

  var _href = _userElement.getAttribute('xlink:href');
...
},{"vue":"node_modules/vue/dist/vue.common.js","./button":"src/button.vue","./icon":"src/icon.vue","./buttonGroup":"src/buttonGroup.vue","chai":"node_modules/chai/index.js","chai-spies":"node_modules/chai-spies/chai-spies.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
