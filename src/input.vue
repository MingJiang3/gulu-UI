<template>
<div class="wraper" :class="{error}">
    <input :value="value" type="text" :disabled="disabled" :readonly="readonly"
    @change="$emit('change',$event,'4444')" @input="$emit('input',$event)"
...
<style lang="scss" scoped>
    ...
    $red: #f14530;
    .wraper{font-size: $font-size;display: inline-flex;align-items: center;
        ...
        > input{height: 32px;border: 1px solid $border-color;border-radius: 4px;padding: 0 8px;font-size: inherit;
            ...
            &[readonly]{border-color: #aaa;color: #aaa;} }
